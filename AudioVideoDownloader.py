...
def download1080pVideo(ipString=None, folderToUse=""):
    """
    download a single HD Video from youtube URL

    return path_to_downloaded_video, video_title
    """
    ...
    PATH_to_final_video = PATH+"\\"+save_title+".mp4"

    return PATH_to_final_video, video_title


"""
# initially it was like this edited to make above version
...
def download160kbpsAudio(ipString=None, folderToUse=""):
    """
    download a single Audio from youtube URL

    return path_to_downloaded_audio, Save_title
    """
    if ipString.startswith('https://www.youtube.com'):
        URL = ipString
    else:
    ...
    PATH_to_Audio = PATH+"\\"+save_title+".mp3"

    return PATH_to_Audio, save_title
...
if __name__ == '__main__':
    ...
    #VideoToDownload = input("enter url or title of video:")
